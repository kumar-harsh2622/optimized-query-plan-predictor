    ...
    <Batch>
      <Statements>
        <StmtSimple StatementCompId="1" StatementEstRows="1" StatementId="1" StatementOptmLevel="FULL" StatementOptmEarlyAbortReason="TimeOut" CardinalityEstimationModelVersion="150" StatementSubTreeCost="3.22474" StatementText="&#xD;&#xA;SELECT MIN(mi_idx.info) AS info,&#xD;&#xA;       MIN(t.title) AS movie_title&#xD;&#xA;FROM imdb.dbo.info_type AS it,&#xD;&#xA;     imdb.dbo.keyword AS k,&#xD;&#xA;     imdb.dbo.movie_info_idx AS mi_idx,&#xD;&#xA;     imdb.dbo.movie_keyword AS mk,&#xD;&#xA;     imdb.dbo.title AS t&#xD;&#xA;WHERE it.info =''locations''&#xD;&#xA;  AND k.keyword LIKE ''%sequel%''&#xD;&#xA;  AND mi_idx.info &gt; ''747.5''&#xD;&#xA;  AND t.production_year &gt; 1997&#xD;&#xA;  AND t.id = mi_idx.movie_id&#xD;&#xA;  AND t.id = mk.movie_id&#xD;&#xA;  AND mk.movie_id = mi_idx.movie_id&#xD;&#xA;  AND k.id = mk.keyword_id&#xD;&#xA;  AND it.id = mi_idx.info_type_id" StatementType="SELECT" QueryHash="0x113190FBB5831A6D" QueryPlanHash="0x9CB155223798AC22" RetrievedFromCache="false" SecurityPolicyApplied="false">
          ...
          <QueryPlan NonParallelPlanReason="NoParallelPlansInDesktopOrExpressEdition" CachedPlanSize="160" CompileTime="20" CompileCPU="20" CompileMemory="1848">
            <MissingIndexes>
            ...
            <OptimizerHardwareDependentProperties EstimatedAvailableMemoryGrant="103769" EstimatedPagesCached="51884" EstimatedAvailableDegreeOfParallelism="4" MaxCompileMemory="2327200" />
            <OptimizerStatsUsage>
            ...
            <RelOp AvgRowSize="193" EstimateCPU="2.28047E-06" EstimateIO="0" EstimateRebinds="0" EstimateRewinds="0" EstimatedExecutionMode="Row" EstimateRows="1" LogicalOp="Aggregate" NodeId="0" Parallel="false" PhysicalOp="Stream Aggregate" EstimatedTotalSubtreeCost="3.22474">
              <OutputList>
              ...
              <StreamAggregate>
                ...
                <RelOp AvgRowSize="193" EstimateCPU="0.00178262" EstimateIO="0" EstimateRebinds="0" EstimateRewinds="0" EstimatedExecutionMode="Batch" EstimateRows="2.96746" LogicalOp="Inner Join" NodeId="1" Parallel="false" PhysicalOp="Hash Match" EstimatedTotalSubtreeCost="3.22474">
                  <OutputList>
                    <ColumnReference Database="[imdb]" Schema="[dbo]" Table="[movie_info_idx]" Alias="[mi_idx]" Column="info" />
                    <ColumnReference Database="[imdb]" Schema="[dbo]" Table="[title]" Alias="[t]" Column="title" />
                  </OutputList>
                  ...
                  <Hash BitmapCreator="true">
                    ...
                    <RelOp AvgRowSize="24" EstimateCPU="0.00192425" EstimateIO="0" EstimateRebinds="0" EstimateRewinds="0" EstimatedExecutionMode="Batch" EstimateRows="4.94332" LogicalOp="Inner Join" NodeId="2" Parallel="false" PhysicalOp="Hash Match" EstimatedTotalSubtreeCost="1.54022">
                      <OutputList>
                        <ColumnReference Database="[imdb]" Schema="[dbo]" Table="[movie_info_idx]" Alias="[mi_idx]" Column="info" />
                        <ColumnReference Database="[imdb]" Schema="[dbo]" Table="[movie_keyword]" Alias="[mk]" Column="movie_id" />
                      </OutputList>
                      ...
                      <Hash BitmapCreator="true">
                          ...
                          <Hash BitmapCreator="true">
                            ...
                            <RelOp AvgRowSize="15" EstimateCPU="0.497648" EstimateIO="0.553495" EstimateRebinds="0" EstimateRewinds="0" EstimatedExecutionMode="Batch" EstimateRows="452.393" EstimatedRowsRead="452.393" LogicalOp="Clustered Index Scan" NodeId="7" Parallel="false" PhysicalOp="Clustered Index Scan" EstimatedTotalSubtreeCost="1.05114" TableCardinality="4523930">
                              ...
                              <IndexScan Ordered="false" ForcedIndex="false" ForceSeek="false" ForceScan="false" NoExpandHint="false" Storage="ColumnStore">
                                ...
                                <Predicate>
                                  <ScalarOperator ScalarString="PROBE([Opt_Bitmap1049],[imdb].[dbo].[movie_keyword].[keyword_id] as [mk].[keyword_id])">
                        ...
                        <RelOp AvgRowSize="20" EstimateCPU="0.00177657" EstimateIO="0" EstimateRebinds="0" EstimateRewinds="0" EstimatedExecutionMode="Batch" EstimateRows="1.67491" LogicalOp="Inner Join" NodeId="8" Parallel="false" PhysicalOp="Hash Match" EstimatedTotalSubtreeCost="0.363587">
                          <OutputList>
                            <ColumnReference Database="[imdb]" Schema="[dbo]" Table="[movie_info_idx]" Alias="[mi_idx]" Column="movie_id" />
                            <ColumnReference Database="[imdb]" Schema="[dbo]" Table="[movie_info_idx]" Alias="[mi_idx]" Column="info" />
                          </OutputList>
                              ...
                              <Filter StartupExpression="false">
                                <RelOp AvgRowSize="24" EstimateCPU="0.15182" EstimateIO="0.206829" EstimateRebinds="0" EstimateRewinds="0" EstimatedExecutionMode="Batch" EstimateRows="13.8004" EstimatedRowsRead="13.8004" LogicalOp="Clustered Index Scan" NodeId="12" Parallel="false" PhysicalOp="Clustered Index Scan" EstimatedTotalSubtreeCost="0.358648" TableCardinality="1380040">
                                  ...
                                  <IndexScan Ordered="false" ForcedIndex="false" ForceSeek="false" ForceScan="false" NoExpandHint="false" Storage="ColumnStore">
                                    ...
                                    <Predicate>
                                      <ScalarOperator ScalarString="PROBE([Opt_Bitmap1048],[imdb].[dbo].[movie_info_idx].[movie_id] as [mi_idx].[movie_id]) AND PROBE([Opt_Bitmap1050],[imdb].[dbo].[movie_info_idx].[info_type_id] as [mi_idx].[info_type_id])">
                    ...
                    <RelOp AvgRowSize="194" EstimateCPU="0.27813" EstimateIO="1.40461" EstimateRebinds="0" EstimateRewinds="0" EstimatedExecutionMode="Batch" EstimateRows="1.51371" EstimatedRowsRead="2.52831" LogicalOp="Clustered Index Scan" NodeId="14" Parallel="false" PhysicalOp="Clustered Index Scan" EstimatedTotalSubtreeCost="1.68274" TableCardinality="2528310">
                      ...
                      <IndexScan Ordered="false" ForcedIndex="false" ForceSeek="false" ForceScan="false" NoExpandHint="false" Storage="ColumnStore">
                        ...
                        <Predicate>
                          <ScalarOperator ScalarString="[imdb].[dbo].[title].[production_year] as [t].[production_year]&gt;(1997) AND PROBE([Opt_Bitmap1069],[imdb].[dbo].[title].[id] as [t].[id])">
                            <Logical Operation="AND">
                              <ScalarOperator>
                                <Compare CompareOp="GT">
                                  <ScalarOperator>
