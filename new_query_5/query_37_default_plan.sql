      ...
      <Statements>
        <StmtSimple StatementCompId="1" StatementEstRows="1" StatementId="1" StatementOptmLevel="FULL" StatementOptmEarlyAbortReason="TimeOut" CardinalityEstimationModelVersion="150" StatementSubTreeCost="3.58638" StatementText="&#xD;&#xA;SELECT MIN(t.title) AS movie_title&#xD;&#xA;FROM imdb.dbo.company_name AS cn,&#xD;&#xA;     imdb.dbo.keyword AS k,&#xD;&#xA;     imdb.dbo.movie_companies AS mc,&#xD;&#xA;     imdb.dbo.movie_keyword AS mk,&#xD;&#xA;     imdb.dbo.title AS t&#xD;&#xA;WHERE cn.country_code =''[id]''&#xD;&#xA;  AND k.keyword =''public-hearing''&#xD;&#xA;  AND cn.id = mc.company_id&#xD;&#xA;  AND mc.movie_id = t.id&#xD;&#xA;  AND t.id = mk.movie_id&#xD;&#xA;  AND mk.keyword_id = k.id&#xD;&#xA;  AND mc.movie_id = mk.movie_id" StatementType="SELECT" QueryHash="0x1ED368BF3E460FBE" QueryPlanHash="0x99DFEE3812134D3E" RetrievedFromCache="false" SecurityPolicyApplied="false">
          ...
          <QueryPlan NonParallelPlanReason="NoParallelPlansInDesktopOrExpressEdition" CachedPlanSize="160" CompileTime="17" CompileCPU="17" CompileMemory="1632">
            ...
            <OptimizerHardwareDependentProperties EstimatedAvailableMemoryGrant="103769" EstimatedPagesCached="51884" EstimatedAvailableDegreeOfParallelism="4" MaxCompileMemory="1960664" />
            <OptimizerStatsUsage>
            ...
            <RelOp AvgRowSize="186" EstimateCPU="2.75623E-06" EstimateIO="0" EstimateRebinds="0" EstimateRewinds="0" EstimatedExecutionMode="Row" EstimateRows="1" LogicalOp="Aggregate" NodeId="0" Parallel="false" PhysicalOp="Stream Aggregate" EstimatedTotalSubtreeCost="3.58638">
              <OutputList>
              ...
              <StreamAggregate>
                ...
                <RelOp AvgRowSize="186" EstimateCPU="0.00597474" EstimateIO="0" EstimateRebinds="0" EstimateRewinds="0" EstimatedExecutionMode="Batch" EstimateRows="3.76039" LogicalOp="Inner Join" NodeId="1" Parallel="false" PhysicalOp="Hash Match" EstimatedTotalSubtreeCost="3.58637">
                  <OutputList>
                    <ColumnReference Database="[imdb]" Schema="[dbo]" Table="[title]" Alias="[t]" Column="title" />
                  </OutputList>
                  ...
                  <Hash BitmapCreator="true">
                    ...
                    <RelOp AvgRowSize="11" EstimateCPU="0.000112799" EstimateIO="0" EstimateRebinds="0" EstimateRewinds="0" EstimatedExecutionMode="Batch" EstimateRows="4.82429" LogicalOp="Filter" NodeId="13" Parallel="false" PhysicalOp="Filter" EstimatedTotalSubtreeCost="0.0468809">
                      <OutputList>
                        <ColumnReference Database="[imdb]" Schema="[dbo]" Table="[company_name]" Alias="[cn]" Column="id" />
                      </OutputList>
                      <Filter StartupExpression="false">
