...
<ShowPlanXML xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" Version="1.539" Build="15.0.2000.5" xmlns="http://schemas.microsoft.com/sqlserver/2004/07/showplan">
  <BatchSequence>
    <Batch>
      <Statements>
        <StmtSimple StatementCompId="1" StatementEstRows="1" StatementId="1" StatementOptmLevel="FULL" StatementOptmEarlyAbortReason="TimeOut" CardinalityEstimationModelVersion="150" StatementSubTreeCost="3.58639" StatementText="&#xD;&#xA;SELECT MIN(t.title) AS movie_title&#xD;&#xA;FROM imdb.dbo.company_name AS cn,&#xD;&#xA;     imdb.dbo.keyword AS k,&#xD;&#xA;     imdb.dbo.movie_companies AS mc,&#xD;&#xA;     imdb.dbo.movie_keyword AS mk,&#xD;&#xA;     imdb.dbo.title AS t&#xD;&#xA;WHERE cn.country_code =''[ph]''&#xD;&#xA;  AND k.keyword =''character-name-in-title''&#xD;&#xA;  AND cn.id = mc.company_id&#xD;&#xA;  AND mc.movie_id = t.id&#xD;&#xA;  AND t.id = mk.movie_id&#xD;&#xA;  AND mk.keyword_id = k.id&#xD;&#xA;  AND mc.movie_id = mk.movie_id" StatementType="SELECT" QueryHash="0x1ED368BF3E460FBE" QueryPlanHash="0x99DFEE3812134D3E" RetrievedFromCache="false" SecurityPolicyApplied="false">
          <StatementSetOptions ANSI_NULLS="true" ANSI_PADDING="true" ANSI_WARNINGS="true" ARITHABORT="true" CONCAT_NULL_YIELDS_NULL="true" NUMERIC_ROUNDABORT="false" QUOTED_IDENTIFIER="true" />
          <QueryPlan NonParallelPlanReason="NoParallelPlansInDesktopOrExpressEdition" CachedPlanSize="152" CompileTime="16" CompileCPU="16" CompileMemory="1696">
            <MissingIndexes>
              <MissingIndexGroup Impact="19.2747">
            ...
            <OptimizerHardwareDependentProperties EstimatedAvailableMemoryGrant="103769" EstimatedPagesCached="51884" EstimatedAvailableDegreeOfParallelism="4" MaxCompileMemory="2011616" />
            <OptimizerStatsUsage>
            ...
            <RelOp AvgRowSize="186" EstimateCPU="9.99992E-06" EstimateIO="0" EstimateRebinds="0" EstimateRewinds="0" EstimatedExecutionMode="Row" EstimateRows="1" LogicalOp="Aggregate" NodeId="0" Parallel="false" PhysicalOp="Stream Aggregate" EstimatedTotalSubtreeCost="3.58639">
              <OutputList>
              ...
              <StreamAggregate>
                ...
                <RelOp AvgRowSize="186" EstimateCPU="0.00598275" EstimateIO="0" EstimateRebinds="0" EstimateRewinds="0" EstimatedExecutionMode="Batch" EstimateRows="15.8332" LogicalOp="Inner Join" NodeId="1" Parallel="false" PhysicalOp="Hash Match" EstimatedTotalSubtreeCost="3.58638">
                  <OutputList>
                    <ColumnReference Database="[imdb]" Schema="[dbo]" Table="[title]" Alias="[t]" Column="title" />
                  </OutputList>
                  ...
                  <Hash BitmapCreator="true">
                    ...
                    <RelOp AvgRowSize="11" EstimateCPU="0.000112799" EstimateIO="0" EstimateRebinds="0" EstimateRewinds="0" EstimatedExecutionMode="Batch" EstimateRows="20.3128" LogicalOp="Filter" NodeId="13" Parallel="false" PhysicalOp="Filter" EstimatedTotalSubtreeCost="0.0468809">
                      <OutputList>
                        <ColumnReference Database="[imdb]" Schema="[dbo]" Table="[company_name]" Alias="[cn]" Column="id" />
                      </OutputList>
                      <Filter StartupExpression="false">
